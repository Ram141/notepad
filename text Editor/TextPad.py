...
def display_help_messagebox(event=None):
    ...
    tkinter.messagebox.showinfo(
        ...
        "Help", "Help Book: \nTextPad\nBharath\nfor any queries please mail me to below mail id \nmullaguri.vbharath@gmail.com",
...
"""shortcut_bar = Frame(root,  height=25, background='lightgrey')
...
for i, icon in enumerate(icons):
    ...
    tool_bar = Button(shortcut_bar, image=tool_bar_icon, command=cmd,width=20,height=20)
...
line_number_bar = Text(root, width=3, padx=3, takefocus=0,  border=0,
